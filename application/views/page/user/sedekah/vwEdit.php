...
<div class="col-md-9">
    ...
    <div class='row'>
      ...
      <?php
        ...
        <?php }
      ?>
     <?php echo form_open_multipart('sedekahilmu/ubah_sedekah') ?>
         <div class="form-horizontal">
            <div class="form-group">
              <label for="judul" class="col-sm-3 control-label">Judul</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="judul" name='judul' placeholder="Judul..." required value="<?php echo $this->session->userdata("judul") != '' ? $this->session->userdata("judul") : $sedekahilmu['judul']; ?>" />
                <input type="hidden" class="form-control" id="ilmu_id" name='ilmu_id' placeholder="ilmu_id..." required value="<?php echo $sedekahilmu['ilmu_id']; ?>" />
                <input type="hidden" class="form-control" id="url_gambar" name='url_gambar' placeholder="url_gambar..." required value="<?php echo $sedekahilmu['gambar']; ?>" />
                <input type="hidden" class="form-control" id="url_thumb" name='url_thumb' placeholder="url_thumb..." required value="<?php echo $sedekahilmu['thumbnail']; ?>" />
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select class="form-control" name='statuspublish_id' required >
                	<option value='1' <?php echo $sedekahilmu["statuspublish_id"] == 1 ? 'selected' : '' ; ?> > Publish </option>
                	<option value='2' <?php echo $sedekahilmu["statuspublish_id"] == 2 ? 'selected' : '' ; ?>> Draft </option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
				 <select data-placeholder="Tags.." style="width:100%;" multiple class="chosen-select-no-results" tabindex="11" name="kategoriilmu_id[]" >
		            <option value=""></option>
		            <?php foreach($kategori->result() as $row){ ?>
		            	<option value="<?php echo $row->kategoriilmu_id; ?>" <?php echo in_array($row->kategoriilmu_id,$listkategori) ? 'selected' : '' ?>><?php echo $row->kategoriilmu_nm; ?></option>
		            <?php } ?>
		          </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea class="form-control" id="deskripsi" style="min-height:500px" name='deskripsi' placeholder="Deskripsi..." ><?php echo $this->session->userdata("deskripsi") != '' ? $this->session->userdata("deskripsi") : $sedekahilmu['deskripsi'] ; ?></textarea>
              </div>
            </div>
            <div class="form-group" style='margin-top:0px'>
    			...
    			<div class='col-sm-1'>
    				...
    				<div id="upload" class="btn btn-default" style=''>
    					...
    					<div id="thumbnail"><img src="<?php echo base_url($sedekahilmu['gambar'] != '' ? $sedekahilmu['gambar'] : 'assets/img/no_image_availabel.png') ?>" /></div>
    				</div>
    			</div>
    		</div>
            <div class="form-group">
