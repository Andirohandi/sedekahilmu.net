    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb" style='color:fff'>
               ...
               <li class="active">List Sedekah Ilmu</li>
            </ol>
        </div>
    </div>
    <div class='row'>
        ...
        <div class='col-sm-2 col-xs-12' style='margin-top:5px;margin-bottom:5px'>
            <a href="<?php echo base_url('users/sedekah/add')?>" class="btn btn-success" ><i class="glyphicon glyphicon-plus"></i> Create</a>
        </div>
...
function pageLoad(i){
	...
	$.ajax({
		url		: '<?php echo base_url()?>sedekahilmu/read/'+i,
		type	: 'post',
		dataType: 'html',
